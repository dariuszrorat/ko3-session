 ...
 */
class Kohana_Session_Postgresql extends Session_Common
{
    ...
    public function __construct(array $config, $id = null)
    {
        ...
        if (0 == count($result))
        {
            ...
            {
                throw new Session_Exception('Failed to create new PostgreSQL table with the following error : :error', array(':error' => $e->getMessage()));
            }
        }
